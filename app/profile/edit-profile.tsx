      ...
      try {
        await authClient.updateUser({
          ...
          fetchOptions: {
            ...
            onSuccess() {
              setisLoading(false)
              toast({ title: 'Profile updated!', description: 'Kindly refresh the page to see changes!' })
            },
            onError(context) {
              toast({ title: `Error`, description: context.error?.message || context.error?.statusText, variant: 'destructive' });
            }
          }
